...
Install tshark in client container first, otherwise none of this is going to work.
TODO maybe I should add it in the client docker image
...
for i in range(61, 81):
    ...
    for j in range(100):
        ...
        # write to file for closer inspection
        '''
        ...
        # write to file for closer inspection
        # with open("sample.json", "w") as outfile:
        #    json.dump(unnested_data_dict, outfile)
